...
;Texts = {closeWindow:'Fechar janela',okButton:'OK',warning:'Warning',error:'Error',today:'today',yesterday:'yesterday',daysAgo:'{0} days ago',monthsAgo:'{0} months ago',yearsAgo:'{0} years ago',addCart:'Add to Cart',shoppingCart:'Carrinho de compras',edit:'Criado {0} com {1}',continueShopping:'Continue shopping',buyNow:'Buy Now',processedByPaypal:'Payment processed by PayPal',viewCart:'View Cart',emptyCart:'Empty Cart',removeAllItems:'Remove all items?',yes:'Yes',no:'No',item:'item',items:'items',success:'Success',couponCode:'Coupon code',redeem:'Redeem',noSuch:'No such coupon exists!',expired:'The coupon code <b>{0}</b> has expired!',lowerThanCurrent:'This coupon offers lower discount than the current <b>{0}</b>.',reclaimed:'This coupon has already been used!',subtotal:'Subtotal',total:'Total',shippingAndHandling:'Shipping and handling',reduction:'Reduction',discount:'Discount',tax:'Tax',remove:'Remove',couponAccepted:'Coupon code accepted, discounting <b>{0}</b>.',couponRemoved:'Coupon has been removed.',amountLowerThan:'The amount is lower than the discount <b>{0}</b>.',addMoreItems:'Add {0} more item(s) to use this coupon!',validAbove:'Valid only above {0} cart value.',higherThanTotal:'Coupon provides higher discount (<b>{0}</b>) than the cart total.',minAmountWarning:'This coupon can only be used if the total amount exceeds <b>{0}</b>.',minQuantityWarning:'This coupon can only be used if the number of items exceeds <b>{0}</b>.',maxNItems:'Maximum <b>{0}</b> items allowed!',continueBrowsing:'Continue browsing',feedback:'Feedback',feedbackOnAlbum:'Feedback on album "{0}"',overLimitWarning:'This is too much to pass to the email application directly. Please copy / paste the text below to the email body!',share:'Partilhar',shareOn:'Partilhar no',checkOutThis:'Veja só isto',localWarning:'Can´t share local albums. Please upload your album first!',foundNTimes:'{0} image(s)',notFound:'Sem resultados',search:'<b>Procurar</b> (botão)',newImages:'New images',label:'Label',return:'return',and:'and',newItem:'NOVO',today:'today',inTheLastDay:'in the last day',inThePastNDays:'in the past {0} days',inThePastNMonths:'in the past {0} months',inThePastNYears:'in the past {0} years',sinceMyLastVisit:'since my last visit',imagesAdded:'Images added',imagesModified:'Images modified',imagesTaken:'Images taken',startSlideshow:'Começar <b>apresentação</b> <em>Numpad *</em>',atFirstPage:'Na primeira página',atLastPage:'Na última página',atLastPageQuestion:'O que deseja fazer agora?',startOver:'Começar novamente',backToHome:'Voltar ao início',stop:'Parar',pause:'Pause',upOneLevel:'<b>Subir</b> um nível',backToIndex:'Voltar à <b>página das miniaturas</b> / subir um nível <em>Esc</em>',previousPicture:'<b>Fotografia</b> anterior <em>Seta esquerda</em><em>Carregar à direita</em>',nextPicture:'<b>Próxima</b> fotografia <em>Seta direita</em><em>Carregar à esquerda</em>',previousFolder:'Previous folder',nextFolder:'Next folder',oneToOneSize:'Tamanho 1:1',fitToScreen:'Ajustar ao ecrã',showInfo:'Deseja um botão grande "Começar apresentação" na imagem do tema?',hideInfo:'Ocultar informações',showThumbs:'Mostrar miniaturas',hideThumbs:'Ocultar miniaturas',clickToOpen:'Clique para abrir este documento com o programa predefinido',metaBtn:'Dados da fotografia',metaLabel:'Mostrar informação Exif/Iptc',mapBtn:'Mapa',mapLabel:'Mostrar a localização da fotografia no mapa',shopBtn:'Comprar',shopLabel:'Mostrar opções de compra deste item',shareBtn:'Partilhar',shareLabel:'Partilhar esta fotografia nas redes sociais',download:'Descarregar',print:'Print',printLabel:'Print out this photo on your printer',fotomotoBtn:'Buy / Share',fotomotoLabel:'Buy prints or digital files, share, send free eCards',mostphotosBtn:'Purchase',mostphotosLabel:'Download this image from <b>mostphotos.com</b>!',regionsBtn:'People',regionsLabel:'Show tagged people',sendFeedback:'Send feedback',message:'Message',subject:'Subject',comment:'Comment',yourEmail:'Your email',send:'Send',messageSent:'Message sent',errorSending:'Error sending',tooLong:'Too long',emailMissing:'Email missing',noItemsSelected:'No items selected',selectItemsHint:'Select the desired items first!',scrollTopTooltip:'Top',more:'more',less:'less',locationWarning:'Works only when uploaded',cookiePolicyText:'This album uses cookies to remember user preferences. By using it, you agree to our use of cookies.',cookiePolicyAgree:'Got it',cookiePolicyLearnMore:'Learn more'};
